// ignore_for_file: prefer_null_aware_operators, unnecessary_null_comparison, non_constant_identifier_names
...
class ProductWishListModel {
  ...
  ProductWishListModel.fromJsonMap(Map<String, dynamic>map)
      :  id = map['id'],
         user_id = map['user_id'],
