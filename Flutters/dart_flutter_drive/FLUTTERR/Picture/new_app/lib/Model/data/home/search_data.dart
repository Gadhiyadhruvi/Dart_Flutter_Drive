// ignore_for_file: non_constant_identifier_names, camel_case_types, prefer_null_aware_operators, unnecessary_null_comparison

class ProductDataList{
  final List<SearchDataListData> searchDataListData;

  ProductDataList.fromJsonMap(Map<String,dynamic> map):
        searchDataListData = List<SearchDataListData>.from(map["productList"].map((it) => SearchDataListData.fromJsonMap(it))).toList();

  Map<String, dynamic> toJson() {
    Map<String, dynamic> data = <String, dynamic>{};
    data['productList'] = searchDataListData != null ? searchDataListData.map((e) => e.toJson()).toList() : null;
    return data;
  }
}

class SearchDataListData {
  final int id;
  ...
  SearchDataListData.fromJsonMap(Map<String, dynamic> map)
      : id = map['id'],
