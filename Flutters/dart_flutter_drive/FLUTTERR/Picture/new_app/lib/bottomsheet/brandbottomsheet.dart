                ...
                child: Column(
                  ...
                  children: [
                    Container(
                      ...
                      child: const Text("Select Brand:",style: TextStyle(fontWeight: FontWeight.bold,letterSpacing: 1,fontSize: 15),),
                    ),
                    Expanded(
                            ...
                            return InkWell(
                              ...
                              child: Card(
                                ...
                                child: Container(
                                  ...
                                  child: Text(brandApi[index].name,style: const TextStyle(fontSize: 15)),
                                ),
                              ),
                            );
                          }
