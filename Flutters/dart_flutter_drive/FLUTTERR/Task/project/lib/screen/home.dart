      ...
      children: [
        Container(
          ...
          child: const Text(
            "FOOD  EXPRESS",
            style: TextStyle(
                color: Color.fromARGB(255, 80, 212, 230),
                fontSize: 30,
        ...
        SizedBox(
          ...
          child: Image.network(
              "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRzLAyOicIWbKKJYvlV6lz1JRKsxe8nk-rEgw&usqp=CAU"),
        ),
        const Text(
          "Delivery to your Home",
          style: TextStyle(
              color: Color.fromARGB(255, 33, 131, 223),
              fontSize: 30,
              fontWeight: FontWeight.bold),
        ),
        Container(
          ...
          child: const Text(
            " Pavlova is a merineue-based dessert named after the Russian ballerina Anna Pavlova fealures a crisp crust and soft,light inside,lopped with fruit and whipped cream.",
            style: TextStyle(
                color: Color.fromARGB(255, 10, 67, 119),
                fontSize: 20,
                fontWeight: FontWeight.bold),
          ),
        ),
            ...
            children: [
              ...
              GestureDetector(
                ...
                child: Container(
                  ...
                  width: 80,
                  alignment: Alignment.center,
                  margin: const EdgeInsets.only(left: 132, top: 30),
                  decoration: const BoxDecoration(
                  ...
                  child: const Text(
                    "NEXT",
                    style: TextStyle(
                      color: Color.fromARGB(255, 111, 152, 223),
                      fontSize: 20,
                    ),
                  ),
                ),
      ...
      children: [
        Container(
          ...
          child: const Text(
            "ALODOKTER",
            style: TextStyle(
                color: Color.fromARGB(255, 46, 27, 221),
                fontSize: 30,
                fontWeight: FontWeight.bold),
          ),
        ),
        Container(
          ...
          child: const Text(
            "Chat Dokter Pilihan Kami",
            style: TextStyle(
                color: Color.fromARGB(255, 69, 50, 237),
                fontSize: 15,
                fontWeight: FontWeight.bold),
          ),
        ),
        SizedBox(
          ...
          width: double.maxFinite,
          child: Image.network(
              "https://technode.global/wp-content/uploads/2021/06/stethoscope-2617701_1920.jpg"),
        ),
        Container(
          margin: const EdgeInsets.only(bottom: 30, top: 30),
          child: const Text(
            "Dapatkan fhdd rnd hje ehjs edebfj sdie jddnjnf ffnbs dn rfu sryue hfb bduj.",
            style: TextStyle(
                color: Color.fromARGB(255, 33, 131, 223),
                fontSize: 15,
                fontWeight: FontWeight.bold),
    ...
    return Scaffold(
      ...
      children: [
        ...
        SizedBox(
          ...
          width: double.maxFinite,
          child: Image.network(
              "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRNiJNbGvTjYJvPq5GwRrBLzd2P6XyNUitYIXk-hwvJg23L8YdNLKKR8H6VdYUS9_eQsac&usqp=CAU"),
        ),
        Container(
          margin: const EdgeInsets.only(bottom: 30, top: 30),
          child: const Text(
    ...
    return Scaffold(
      ...
      children: [
        ...
        GestureDetector(
          onTap: () {
            Navigator.push(
                context, MaterialPageRoute(builder: (((context) => const home3()))));
          },
          child: Container(
            height: 50,
            width: 120,
    ...
    return Scaffold(
      ...
      children: [
        ...
        SizedBox(
          ...
          width: double.maxFinite,
          child: Image.network(
              "https://telko.id/wp-content/uploads/2022/06/Image-Press-Release-Aloproteksi-Plus-2022-B2-scaled.jpg"),
        ),
        Container(
          margin: const EdgeInsets.only(bottom: 30, top: 30),
          child: const Text(
    ...
    return Scaffold(
      body: Column(
        children: [
          ...
          Container(
            alignment: Alignment.center,
            margin: const EdgeInsets.only(bottom: 30, top: 30, left: 40, right: 40),
            child: const Text(
    ...
    return Scaffold(
      ...
      children: [
        SizedBox(
          ...
          width: double.maxFinite,
          child: Image.network(
            "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTmLm_zLA2-iEF0tIKM4lkq3fBnGHip8sF2bg&usqp=CAU",
            fit: BoxFit.cover,
          ),
        ),
        Container(
      ...
      body: Column(
        children: [
          Container(
            ...
            margin: const EdgeInsets.only(bottom: 30, top: 30),
            child: Image.network(
              "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTrGYulvE5HcLjvrgMYq-722n3VsKVKAJC4_g&usqp=CAU",
              fit: BoxFit.cover,
            ),
          ),
          Container(
      ...
      body: Column(
        children: [
          ...
          GestureDetector(
            onTap: () {
              Navigator.push(context,
                  MaterialPageRoute(builder: (((context) => const Screenn1()))));
            },
            child: Container(
              height: 30,
              width: 80,
        ...
        children: [
          ...
          Container(
            child: const Text(
              "Book",
              style: TextStyle(
                  color: Color.fromARGB(255, 45, 178, 80),
                  fontSize: 30,
                  fontWeight: FontWeight.bold),
            ),
          ),
          ...
          GestureDetector(
            onTap: () {
              Navigator.push(context,
                  MaterialPageRoute(builder: (((context) => const Screenn2()))));
            },
            child: Container(
              height: 30,
              width: 80,
              ...
              child: const Text(
                "NEXT",
                style: TextStyle(
                  color: Color.fromARGB(255, 12, 15, 20),
                  fontSize: 20,
                ),
              ),
            ),
